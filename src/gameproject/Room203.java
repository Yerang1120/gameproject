...
public class Room203 extends JPanel {
    private final MainFrame mainFrame;

    public Room203(MainFrame mainFrame) {
        ...
        JLabel locationLabel = new JLabel("병실 203호", SwingConstants.RIGHT);
    ...
    private class RoomDrawingPanel extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            //창문
            g.drawRect(550, 70, 300, 200);
            g.drawLine(700, 70, 700, 270);
            g.drawLine(550, 170, 850, 170);
        }
