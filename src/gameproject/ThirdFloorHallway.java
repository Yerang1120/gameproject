...
public class ThirdFloorHallway extends JPanel {
    private final MainFrame mainFrame;
    private final List<ClickableArea> clickableAreas = new ArrayList<>();

    public ThirdFloorHallway(MainFrame mainFrame) {
        ...
        // 위치 라벨 (오른쪽 위)
        JLabel locationLabel = new JLabel("병동 3층 복도", SwingConstants.RIGHT);
        ...
        addClickableArea(220, 150, 150, 350, () -> mainFrame.switchToPanel(new Room301(mainFrame))); // 401호
        addClickableArea(390, 150, 150, 350, () -> mainFrame.switchToPanel(new Room302(mainFrame))); // 402호
        addClickableArea(560, 150, 150, 350, () -> mainFrame.switchToPanel(new Room303(mainFrame))); // 403호
        addClickableArea(730, 150, 150, 350, () -> mainFrame.switchToPanel(new Room304(mainFrame))); // 404호
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString("3", 110, 80); // 층수 텍스트 추가
        ...
        g.drawString("301", 285, 130); // 401호 텍스트 추가
        ...
        g.drawString("302", 455, 130); // 402호 텍스트 추가
        ...
        g.drawString("303", 625, 130); // 403호 텍스트 추가
        ...
        g.drawString("304", 795, 130); // 404호 텍스트 추가
